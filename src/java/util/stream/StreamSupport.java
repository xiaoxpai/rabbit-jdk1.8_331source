...
public final class StreamSupport {
    ...
    public static <T> Stream<T> stream(Spliterator<T> spliterator, boolean parallel) {
        ...
        return new ReferencePipeline.Head<>(spliterator,
                                            ...
                                            parallel);//StreamOpFlag.fromCharacteristics(spliterator)返回一个StreamOpFlag类型的值,这个值是由spliterator的特征值构成的,这个特征值是由Spliterator的getExactSizeIfKnown()方法返回的,这个方法是由Spliterator的子类实现的,比如ArraySpliterator,HashSetSpliterator等等,这些子类都实现了getExactSizeIfKnown()方法,这个方法返回的是一个long类型的值,这个值是由Spliterator的特征值构成的,这个特征值是由Spliterator的getExactSizeIfKnown()方法返回的,这个方法是由Spliterator的子类实现的,比如ArraySpliterator,HashSetSpliterator等等,这些子类都实现了getExactSizeIfKnown()方法,这个方法返回的是一个long类型的值,这个值是由Spliterator的特征值构成的,这个特征值是由Spliterator的getExactSizeIfKnown()方法返回的,这个方法是由Spliterator的子类实现的,比如ArraySpliterator,HashSetSpliterator等等,这些子类都实现了getExactSizeIfKnown()方法,这个方法返回的是一个long类型的值,这个值是由Spliterator的特征值构成的,这个特征值是由Spliterator的getExactSizeIfKnown()方法返回的,这个方法是由Spliterator的子类实现的,比如ArraySpliterator,HashSetSpliterator等等,这些子类都实现了getExactSizeIfKnown()方法,这个方法返回的是一个long类型的值,这个值是由Spliterator的特征值构成的,这个特征值是由Spliterator的getExactSizeIfKnown()方法返回的,这个方法是由Spliterator的子类实现的,比如ArraySpliterator,HashSetSpliterator等等,这些子类都实现了getExactSizeIfKnown()方法,这个方法返回的是一个long类型的值,这个值是由Spliterator的特征值构成的,这个特征值是由Spliterator的getExactSizeIfKnown()方法返回的,这个方法是由Spliterator的子类实现的,比如ArraySpliterator,HashSetSpliterator
    }
